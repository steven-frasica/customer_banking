...
def main():
    ...
    # ADD YOUR CODE HERE
    print(f'The interest earned on the savings account is: $', format(interest_earned, ',.2f'))
    print(f'The future savings account balance after {savings_maturity} months is: $', format(updated_savings_balance, ',.2f'))
    ...
    # ADD YOUR CODE HERE
    print(f'The interest earned on the CD account is: $', format(interest_earned, ',.2f'))
    print(f'The future CD account balance after {cd_maturity} months is: $', format(updated_cd_balance, ',.2f'))
